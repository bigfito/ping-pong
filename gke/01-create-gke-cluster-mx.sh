...
GKE_CLUSTER_NAME="one-more-cluster-mx"
GCP_REGION="northamerica-south1"
MACHINE_TYPE="e2-small"
DISK_SIZE="64"
NUM_NODES="2"
CLUSTER_NETWORK="projects/savvy-serenity-447419-d2/global/networks/core-vpc"
NODES_NETWORK="projects/savvy-serenity-447419-d2/regions/$GCP_REGION/subnetworks/a-subnet-vms-gke-nodes"
PODS_NETWORK="b-subnet-pods"
SERVICES_NETWORK="c-subnet-services"
